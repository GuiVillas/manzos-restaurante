...
<div class="bg-neutral-900/50 border border-neutral-800 rounded-sm p-6 mb-6">
    ...
    <div class="relative">
        <input type="text" id="campoPesquisa" placeholder="Filtrar por cliente, mesa ou status..." oninput="pesquisarReservas()"
        ...
        <button type="button" onclick="document.getElementById('campoPesquisa').value=''; pesquisarReservas();"
